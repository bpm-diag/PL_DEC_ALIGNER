...
(:action sync-a-ct1
:precondition (and (currstate t0) (currstate s_0_0) (not (currstate s_1_1)) )
...
(:action sync-a-ct2
:precondition (and (currstate t0) (currstate s_1_1) (not (currstate s_0_3)) (not (currstate s_0_0)) )
...
(:action sync-a-ct4
:precondition (and (currstate t0) (currstate s_0_0) (currstate s_1_1) )
...
(:action sync-a-t0t1
:precondition (and (currstate t0) (not (currstate s_0_3)) (not (currstate s_0_0)) (not (currstate s_1_1)) )
